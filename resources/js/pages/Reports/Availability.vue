...
import { CalendarDays, Users, CalendarCheck, TrendingUp, Download } from 'lucide-vue-next';
import { index as reportsIndex, availability } from '@/routes/reports';
...
const exportUrl = availability.export.url();
...
<template>
    <AppLayout :breadcrumbs="[{ title: 'Reports', href: reportsIndex().url }, { title: 'Instructor Availability' }]">
        <div class="flex flex-col gap-6 p-6">
            <div class="flex items-center justify-between gap-4">
                <div>
                    <h1 class="text-2xl font-bold tracking-tight">Instructor Availability & Booking</h1>
                    <p class="text-sm text-muted-foreground">Slot utilisation per instructor.</p>
                </div>
